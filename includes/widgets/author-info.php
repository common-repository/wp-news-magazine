...
if ( !class_exists('HTmagazine_Author_About_Widget') ) {
	class HTmagazine_Author_About_Widget extends WP_Widget{

		function __construct(){

			$widget_options = array(
				'description' 					=> esc_html__('This widget show author informations', 'ht-magazine'), 
				'customize_selective_refresh' 	=> true,
			);

			parent:: __construct('HTmagazine_Author_About_Widget', esc_html__( 'WPNews: Author Informations', 'ht-magazine'), $widget_options );
		...
		public function widget($args, $instance){ 
	        ...
	        <?php echo $args['before_widget']; ?>
	        	<div class="author--info--wrap">
	        		...
	        		<?php if ( !empty($image) ): ?>
	        			<img src="<?php echo esc_url( $image ) ; ?>" alt="<?php esc_html_e('Author Image', 'ht-magazine'); ?>">
	        		<?php endif ?>
		...
		public function form($instance){ 
			...
			<div class="image_box_wrap" style="margin:20px 0 15px 0; width: 100%;">
				<button class="button button-primary author_info_image">
					<?php esc_html_e('Upload Image', 'ht-magazine'); ?>
				</button>
				<div class="image_box widefat">
					<img src="<?php if( !empty($image)){echo esc_html($image);} ?>" style="margin:15px 0 0 0;padding:0;max-width: 100%;display:inline-block; height: auto;" alt="<?php esc_html_e('', 'ht-magazine'); ?>" />
				</div>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php echo esc_html__('Title:' ,'ht-magazine') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('content')); ?>"><?php echo esc_html__('Content:' ,'ht-magazine') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('social_title')); ?>"><?php echo esc_html__('Social Title:' ,'ht-magazine') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('youtube')); ?>"><?php echo esc_html__('Youtube Link:' ,'ht-magazine') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('pinterest')); ?>"><?php echo esc_html__('Pinterest Link:' ,'ht-magazine') ?></label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('instagram')); ?>"><?php echo esc_html__('Instagram Link:' ,'ht-magazine') ?></label>
...
function HTmagazine_Author_About_Widget() {
    register_widget( 'HTmagazine_Author_About_Widget' );
}
add_action( 'widgets_init', 'HTmagazine_Author_About_Widget' );